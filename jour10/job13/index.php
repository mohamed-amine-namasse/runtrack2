...
<body>
    ...
    //on fait une requete SQL pour récupérer le nom des salles et le nom de leur étage.

    $command= "SELECT salles.nom AS nom_salle, etages.nom AS nom_etage FROM salles, etages WHERE salles.id_etage=etages.id;";
